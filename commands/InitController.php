...
class InitController extends Controller
{
    ...
    public function actionIndex($params = null)
    {
        ...
        if ($selected == "1") {
            Yii::$app->runAction('migrate/up', ['migrationPath' => '@vendor/wdmg/yii2-views/migrations', 'interactive' => true]);
        } else if($selected == "2") {
            Yii::$app->runAction('migrate/down', ['migrationPath' => '@vendor/wdmg/yii2-views/migrations', 'interactive' => true]);
        } else {
